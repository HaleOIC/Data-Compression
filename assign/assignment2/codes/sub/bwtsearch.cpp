...
int main(int argv, char** argc) {
	...
	if (query_str[0] == '"' && query_str[query_str.length() - 1] == '"') {
	...
	// cout << selectB_pr('s', 2) << endl;

	// cout << selectB(10) << endl;
	// cout << backward_search(query_str).first << " " << backward_search(query_str).second << endl;
